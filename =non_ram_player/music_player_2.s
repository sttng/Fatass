...
;---------------------------------------------------------------------------
; mus_set_track_shuffle: ctrlbt_shuffle sets the track shuffle
; this is disabled because it needs lots of thinking
;---------------------------------------------------------------------------
;mus_set_track_shuffle:
;	; set up destination
;	ld a,(mus_song_track)
;	add a,o_track_shuffle
;	ld l,a
;	ld h,>mus_ram
;	; read parameter
;	call music_read_parameter_de
...
;	and $0f
;	sla a
;	ld (hli),a	; shuffle rate
;	ld a,b
;	and $f0
;	add a,<mus_shuffle_sinus_0
;	ld (hli),a	; shuffle index
;	ld a,>mus_shuffle_sinus_0
;	adc a,0
;	ld (hli),a
;	xor a
;	ld (hli),a	; shuffle counter
;	ld (hl),a
;	; done
;	jp music_advance_pattern_loop
;---------------------------------------------------------------------------
